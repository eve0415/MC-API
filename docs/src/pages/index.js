...
const features = [
  {
    ...
    description: (
      <>
        Install and require, and you are good to go!
      </>
    ),
  },
  {
    title: 'Fully supports API',
    imageUrl: 'img/compatible.png',
    description: (
      <>
        This project fully supports and compatible with other APIs.
        You don't have to think the difficult part.
      </>
    ),
  },
  {
    title: 'Fully Written in Typescript',
